 ...
 public class DtlsContext {
     ...
     public DtlsContext(DtlsEvent dtlsEvent, DTLSKeyMaterial keyMaterial, DtlsShakeHandsCallback dtlsShakeHandsCallback) {
         this.keyMaterial = keyMaterial;
         this.dtlsShakeHandsCallback = dtlsShakeHandsCallback;
         this.protocol = new DTLSServerProtocol();
         this.tlsServer = new TlsServer(keyMaterial, dtlsShakeHandsCallback);
         this.datagramTransport = new DatagramTransportImpl(dtlsEvent);
     }
     ...
     public interface DtlsEvent {

         void onMessage(DtlsOutputPacket dtlsOutputPacket);
     }
