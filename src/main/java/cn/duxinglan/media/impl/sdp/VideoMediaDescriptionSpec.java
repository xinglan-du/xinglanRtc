 ...
 **/
public class VideoMediaDescriptionSpec implements IMediaDescriptionSpec {


    private final String mid;

    private final boolean isSendOnly;

    private final boolean isReadOnly;

    public VideoMediaDescriptionSpec(String mid, boolean isSendOnly, boolean isReadOnly) {
        this.mid = mid;
