...
import cn.duxinglan.media.signaling.sdp.media.Fingerprint;
import cn.duxinglan.media.signaling.sdp.type.SecurityType;
 ...
 **/
public class FingerprintLineParser extends MediaLineParser {

    public static final String KEY = "fingerprint";
