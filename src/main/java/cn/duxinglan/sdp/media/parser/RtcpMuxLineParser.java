...
import cn.duxinglan.media.signaling.sdp.media.RtcpMux;
 ...
 **/
public class RtcpMuxLineParser extends MediaLineParser {

    public static final String KEY = "rtcp-mux";
    ...
    protected boolean parse(MediaDescription mediaDescription, String key, String value) {
        mediaDescription.setRtcpMux(new RtcpMux(KEY.equals(value)));
        return true;
    }
