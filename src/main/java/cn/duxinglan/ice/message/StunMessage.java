 ...
 @Slf4j
 public abstract class StunMessage implements INetworkPacket, BasePacket {
...
//        this.transactionId = Unpooled.buffer(12);
      ...
      */
     public static Optional<StunMessage> decode(ByteBuf byteBuf) {
         //读取类型
         ...
         return Optional.of(stunMessage);
     }
